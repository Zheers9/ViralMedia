                    ...
                    {preview ? (
                        ...
                        >
                            ...
                            <div style={{
                                ...
                                <CheckCircle size={16} /> {t('image_selected')}
                            </div>
                        </motion.div>
                    ) : (
                        <motion.div
                        ...
                        >
                            ...
                            <h4 style={{ color: 'white', marginBottom: '0.5rem', fontWeight: 600 }}>{t('click_drag_image')}</h4>
                            <p style={{ fontSize: '0.875rem' }}>{t('image_upload_hint')}</p>
                        </motion.div>
                    )}
                </AnimatePresence>
            </motion.div>
